...
<!DOCTYPE html>
  <html>
    ...
    <body>
        <div>
            <p class = "intro">
                Java is a programming language and computing platform first released by Sun Microsystems in 1995.<br>
        ...
        <div>
        <figure>
             <img scr="im/java.png" alt="image does not work">
        </figure>
        </div>
        <div style = "position: relative";>
           <h2>Interesting Facts...</h2>
           <h1>Java was called Oak at the beginning</h1>
            <p> At first, the idea of James Gosling was a big oak tree<br>
               that grew outise his window. But he found that <br>
               the name Oak was already registered by other company.<br><br><br>
               ...
               they were discussing about what name of the language.
            </p>
            <h1>Java was invented by accident</h1>
            <p>
               When James Gosling was working on a set-top box at Sun Labs, <br>
               and he started by "cleaning up" C++, Java came out. 
            </p>
            <h1>Its pays to learn</h1>
            <p>
                The median salary of a Java developer is $83,975.00. <br>
                There are about 9 million Java developers in the world.
            </p>
            <h1>Java is second most popular language after C</h1>
            <p>
                Contrary to what many people think, Java is second most<br>
                popular programming language after C. 
            </p>
            <h1>JUnit Testing Framework</h1>
            <p>
            ...
            <h1>Java is the go to tool for enterprises</h1>
            <p>
        ...
        <div>
            ...
            <li><a href="https://en.wikipedia.org/wiki/Javanese_language">Javanese Language</a></li>
        </div>
   
    <ul>
      <a href="https://www.w3schools.in/java-tutorial/intro/" class = "swagButton">w3school Tutorial</a>
       <a href="http://www.learnjavaonline.org/" class = "swagButton">Java Tutorial</a>
      <a href="https://www.coursera.org/courses?languages=en&query=java" class = "swagButton">Free courses</a>
      <a href="https://www.youtube.com/watch?v=Hl-zzrqQoSE&list=PLFE2CE09D83EE3E28" class = "swagButton">Tutorial Videos</a>
     </ul>
